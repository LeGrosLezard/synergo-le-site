        	...
        	<div class="container">
        		<div class="home_blog_inner">
        			<div class="row h_blog_item">
        				<div class="col-lg-6">
							<div class="h_blog_img">
								<img class="img-fluid" src="/static/img/home-blog/h-blog-1.jpg" alt="">
							</div>
						</div>
						<div class="col-lg-6">
        			...
        			<div class="row h_blog_item">
						...
						<div class="col-lg-6">
							<div class="h_blog_img">
								<img class="img-fluid" src="/static/img/home-blog/h-blog-2.jpg" alt="">
							</div>
						</div>
        			</div>
        			<div class="row h_blog_item">
        				<div class="col-lg-6">
							<div class="h_blog_img">
								<img class="img-fluid" src="/static/img/home-blog/h-blog-3.jpg" alt="">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="h_blog_text">
        			...
        			<div class="row h_blog_item">
						...
						<div class="col-lg-6">
							<div class="h_blog_img">
								<img class="img-fluid" src="/static/img/home-blog/h-blog-4.jpg" alt="">
							</div>
						</div>
        			</div>
        		</div>
        		...
        		<div class="row m0 service_inner">
        			<div class="col-lg-3 col-md-6 p0">
        				<div class="service_img">
        					<img class="img-fluid" src="/static/img/service/service-1.jpg" alt="">
        				</div>
        			</div>
        			<div class="col-lg-3 col-md-6 p0">
        			...
        			<div class="col-lg-3 col-md-6 p0">
        				<div class="service_img">
        					<img class="img-fluid" src="/static/img/service/service-2.jpg" alt="">
        				</div>
        			</div>
        			<div class="col-lg-3 col-md-6 p0">
        				<div class="service_text">
        			...
        			<div class="col-lg-3 col-md-6 p0">
        				<div class="service_img">
        					<img class="img-fluid" src="/static/img/service/service-3.jpg" alt="">
        				</div>
        			</div>
        			<div class="col-lg-3 col-md-6 p0">
        				<div class="service_text">
        			...
        			<div class="col-lg-3 col-md-6 p0">
        				<div class="service_img">
        					<img class="img-fluid" src="/static/img/service/service-4.jpg" alt="">
        				</div>
        			</div>
        		</div>
        	</div>
							...
							<div class="testi_slider_inner">
								<div class="testi_slider owl-carousel">
									<div class="item">
										<div class="media">
											<div class="d-flex">
												<img src="/static/img/testimonials/testi-1.jpg" alt="">
											</div>
        ...
        <section class="instagram_area">
        	<div class="container box_1620">
        		...
        		<div class="instagram_image row m0">
        			<a href="#"><img src="/static/img/instagram/ins-1.jpg" alt=""></a>
        			<a href="#"><img src="/static/img/instagram/ins-2.jpg" alt=""></a>
        			<a href="#"><img src="/static/img/instagram/ins-3.jpg" alt=""></a>
        			<a href="#"><img src="/static/img/instagram/ins-4.jpg" alt=""></a>
        			<a href="#"><img src="/static/img/instagram/ins-5.jpg" alt=""></a>
        			<a href="#"><img src="/static/img/instagram/ins-6.jpg" alt=""></a>
        		</div>
        	</div>
        </section>
        <!--================End Instagram Area =================-->
